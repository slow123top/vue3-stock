...
export const SELECT_INDICATOR = (state, payload) => {
  ...
  if (Object.prototype.hasOwnProperty.call(INDICATORS[INDICATOR_ID], 'select1') && INDICATORS[INDICATOR_ID].select1.length !== 0) {
  ...
  // 第二个input
  if (Object.prototype.hasOwnProperty.call(INDICATORS[INDICATOR_ID], 'params2') && INDICATORS[INDICATOR_ID].params2.length !== 0) {
  ...
  // 第二个select
  if (Object.prototype.hasOwnProperty.call(INDICATORS[INDICATOR_ID], 'select2') && INDICATORS[INDICATOR_ID].select2.length !== 0) {
  ...
  if (Object.prototype.hasOwnProperty.call(INDICATORS[INDICATOR_ID], 'selects')) {
  ...
  if (Object.prototype.hasOwnProperty.call(INDICATORS[INDICATOR_ID], 'radios') && INDICATORS[INDICATOR_ID].radios.length !== 0) {
  ...
  if (CLASS_NAME === 'price-index') {
    for (let i = 0; i < INDEXS.price.length; i++) {
      if (INDEXS.price[i].number === INDEX_ID || INDEXS.price[i].number === INDEX_ID.replace('sell', 'A')) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.price[i], 'radios')) {
    ...
    for (let i = 0; i < INDEXS.marketValue.length; i++) {
      if (INDEXS.marketValue[i].number === INDEX_ID || INDEXS.marketValue[i].number === INDEX_ID.replace('sell', 'A')) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.marketValue[i], 'radios')) {
    ...
    for (let i = 0; i < INDEXS.listingDate.length; i++) {
      if (INDEXS.listingDate[i].number === INDEX_ID || INDEXS.listingDate[i].number === INDEX_ID.replace('sell', 'A')) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.listingDate[i], 'radios')) {
    ...
    for (let i = 0; i < INDEXS.code.length; i++) {
      if (INDEXS.code[i].number === INDEX_ID || INDEXS.code[i].number === INDEX_ID.replace('sell', 'A')) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.code[i], 'radios')) {
    ...
    for (let i = 0; i < INDEXS.trade.length; i++) {
      if (INDEXS.trade[i].number === INDEX_ID || INDEXS.trade[i].number === INDEX_ID.replace('sell', 'A')) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.trade[i], 'radios')) {
    ...
    for (let i = 0; i < INDEXS.classic.length; i++) {
      if (INDEXS.classic[i].number === INDEX_ID || INDEXS.classic[i].number === INDEX_ID.replace('sell', 'A')) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.classic[i], 'radios')) {
    ...
    for (let i = 0; i < INDEXS.secondaryScreen.length; i++) {
      if (INDEXS.secondaryScreen[i].number === INDEX_ID) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.secondaryScreen[i], 'radios')) {
    ...
    for (let i = 0; i < INDEXS.windControl.length; i++) {
      if (INDEXS.windControl[i].number === INDEX_ID) {
        ...
        //添加select
        if (Object.prototype.hasOwnProperty.call(INDEXS.windControl[i],'selects')) {
        ...
        if (Object.prototype.hasOwnProperty.call(INDEXS.windControl[i],'radios')) {
