  ...
  >
    ...
    <i-col span="24">
      <section>
        ...
        <ul>
          <li>
            <router-link to="/personalInfo/buycard">购买回测卡</router-link>之前，请先
            <router-link to="/login">登录</router-link>。
          </li>
          <li>
            购买回测卡仅限于点数购买，若您的点数不足，请先
            <router-link to="/personalInfo/recharge">充值</router-link>点数。
          </li>
          <li>用户只能拥有一种类型的回测卡。</li>
          <li>单次回测卡可以升级和续费。</li>
        </ul>
        <h3>下图中是关于购买单次回测卡详情说明：</h3>
        <img src="../../assets/img/buycard.png" alt="购买单次回测卡图示" />
      </section>
      <section>
        <h2>2.指标</h2>
        ...
        <p class="content">
          <span style="font-weight:bold;color: #80848f">选股指标（灰色）：</span>
          <span>包括价格类指标到经典类指标，与我的模型至少要选择一个；</span>
        </p>
        <p class="content">
          <span style="font-weight:bold;color: #3091f2">二次筛选指标（蓝色）：</span>
          <span>您必须选择一个；</span>
        </p>
        <p class="content">
          <span style="font-weight:bold;color: #19be6b">风控指标（绿色）：</span>
          <span>您可选可不选，若选择只能选择一个</span>
        </p>
        <p class="content">
          <span style="font-weight:bold;color: #FF9933">我的模型（橙色）：</span>
          <span>也就是已经保存的模型，与选股指标至少选择一个。我的模型通过与或非功能，可以和其他任意选股指标或者模型自由组合。</span>
        </p>
      </section>
      <section>
        <h2>3.回测区间</h2>
        ...
        <p class="content">
          回测起点最早可以从
          <span style="color: #ff0000">2016-01-04</span>开始。
        </p>
      ...
      <section>
        ...
        <p
          class="content"
        >千投量化建议用户使用chrome谷歌浏览器，也支持Opera、Firefox、搜狗、QQ、百度、UC、360等最新版本的浏览器；支持IE10及其以上版本的浏览器。</p>
      </section>
    </i-col>
    <i-col span="24">
    ...
    <i-col span="24" style="border-top: 2px solid">
      <section>
        ...
        <img src="../../assets/img/create.png" alt="创建模型流程和回测" />
      </section>
      <section>
        <h2>2.回测结果</h2>
        <img src="../../assets/img/testresult.png" alt="回测结果" />
      </section>
      <section>
        <h2>3.我的模型</h2>
        <h3>(1)首先要进入我的模型页面</h3>
        <div>
          <img src="../../assets/img/mymodel.png" alt="进入我的模型" />
        </div>
        <h3>(2)我的模型页面,查看已保存模型的回测结果</h3>
        <div>
          <img src="../../assets/img/modelresult.png" alt="模型回测结果" />
        </div>
      </section>
      <section>
        <h2>4.加入实盘跟踪</h2>
        <h3>(1)首先加入实盘</h3>
        <div>
          <img src="../../assets/img/addtrack.png" alt="加入实盘跟踪" />
        </div>
        <h3>(2)查看实盘跟踪结果</h3>
        <div>
          <img src="../../assets/img/trackresult.png" alt="实盘跟踪结果" />
        </div>
      </section>
    </i-col>
  </Row>
